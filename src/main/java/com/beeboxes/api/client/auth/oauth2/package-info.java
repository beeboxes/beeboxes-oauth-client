 ...
 * {@link com.beeboxes.api.client.auth.oauth2.AuthorizationCodeRequestUrl} to grant your application
 * access to the end user's protected data.</li>
 * <li>Process the authorization response using
 * {@link com.beeboxes.api.client.auth.oauth2.AuthorizationCodeResponseUrl} to parse the authorization
 * code.</li>
 * <li>Request an access token and possibly a refresh token using
 * {@link com.beeboxes.api.client.auth.oauth2.AuthorizationCodeTokenRequest}.</li>
 * <li>Access protected resources using {@link com.beeboxes.api.client.auth.oauth2.Credential}.
 ...
 * <ul>
 * <li>Redirect the end user in the browser to the authorization page using
 * {@link com.beeboxes.api.client.auth.oauth2.BrowserClientRequestUrl} to grant your browser
...
package com.beeboxes.api.client.auth.oauth2;
